...
mongoose.connect('Your mongoDB connection string', { // monoDB url
...
app.post('/game/hit', async (req, res) => {
	try {
		...
		// Save the updated game to the database with optimistic concurrency control
		game = await Game.findByIdAndUpdate(gameId, game, { new: true });
